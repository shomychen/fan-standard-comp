...
| getFormFields | 获取当前内部控件数据与表单form | Function(fieldsValue, form)  | - | |
...
| isHide | 是否隐藏当前配置的组件 |  Boolean/Function(fieldValues, form)| 否 | fieldValues指当前配置表单内部的所有控件值，form指当前弹窗内部的表单实例  |
